        ...
        {showTooltip && (
          ...
          >
            <button
              ...
              style={{ position: 'absolute', top: 6, right: 8, background: 'none', border: 'none', cursor: 'pointer', color: '#aaa', padding: 2 }}
            >
              <X size={14} />
            </button>
            <div style={{ fontWeight: 700, fontSize: 13, marginBottom: 4 }}>¡Hola! 👋</div>
            <div style={{ fontSize: 12, color: 'var(--gray-500)', lineHeight: 1.5 }}>
              ¿Necesitas sanitarios portátiles? Cotizamos al momento.
            </div>
          </motion.div>
        )}
      </AnimatePresence>
